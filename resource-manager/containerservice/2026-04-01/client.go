...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2026-04-01/identitybindings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2026-04-01/machines"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2026-04-01/managednamespaces"
	"github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2026-04-01/privateendpointconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2026-04-01/privatelinkresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2026-04-01/resolveprivatelinkserviceid"
...
type Client struct {
	...
	IdentityBindings            *identitybindings.IdentityBindingsClient
	...
	ManagedNamespaces           *managednamespaces.ManagedNamespacesClient
...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	...
	identityBindingsClient, err := identitybindings.NewIdentityBindingsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building IdentityBindings client: %+v", err)
	}
	configureFunc(identityBindingsClient.Client)
	...
	managedNamespacesClient, err := managednamespaces.NewManagedNamespacesClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building ManagedNamespaces client: %+v", err)
	}
	configureFunc(managedNamespacesClient.Client)
