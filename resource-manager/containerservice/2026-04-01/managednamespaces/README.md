...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2026-04-01/managednamespaces` Documentation

The `managednamespaces` SDK allows for interaction with Azure Resource Manager `containerservice` (API Version `2026-04-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2026-04-01/managednamespaces"
```
