...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2026-04-01/machines` Documentation

The `machines` SDK allows for interaction with Azure Resource Manager `containerservice` (API Version `2026-04-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2026-04-01/machines"
```
